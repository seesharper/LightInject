...
namespace LightInject.Tests
{
    ...
    internal class ContainerMock : IServiceContainer
    {
        private readonly IInvocationContext<IServiceContainer> context;

        public ContainerMock(IInvocationContext<IServiceContainer> context)
        {
        ...
        {
            context.Invoke(m => m.RegisterAssembly(assembly));
        }
