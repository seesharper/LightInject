...
[LightInject.PreProcessor.SourceWriter]::Write("NET",$sourcepath,"$targetPath\ServiceContainer.cs.pp")
...
$targetPath = $scriptpath + "\package\content\netcore45\"
new-item  $targetPath -itemtype directory -ErrorAction SilentlyContinue
[LightInject.PreProcessor.SourceWriter]::Write("NETFX_CORE",$sourcepath,"$targetPath\ServiceContainer.cs.pp")
